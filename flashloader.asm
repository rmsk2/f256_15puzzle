...
.text "f256_15"                            ; name of the program used for starting
.byte $00                                  ; zero termination for "snake"
.byte $00                                  ; zero termination for parameter description
.text "The puzzle game 15"                 ; Comment shown in lsf
...
BLOCK1 .dstruct BlockSpec_t, $87 - 64, 0, 3, 32  ; copy flash block $42 (block number $87) to RAM block 0. Start at offset $0300
BLOCK2 .dstruct BlockSpec_t, $88 - 64, $10, 0, 32  ; copy flash block $43 (block number $88) to RAM block 16. Start at offset $0000
BLOCK3 .dstruct BlockSpec_t, $89 - 64, $11, 0, 32  ; copy flash block $44 (block number $89) to RAM block 17. Start at offset $0000
